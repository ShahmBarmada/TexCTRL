...
export const meta: MetaFunction = () => {
  return [{ title: "TexCTRL Admin" }, { name: "TexCTRL Mokhmal" }];
};
  ...
  return (
    <div className="bg-slate-800 flex flex-col h-full">
      <div className="px-8 h-12 text-white flex items-center justify-between gap-x-6">
        <NavLink to={"/dashboard/admin"} className={"grow-0 w-48"}>
          <span className="font-[Oxygen] text-xl font-semibold">Admin Lounge</span>
        </NavLink>
